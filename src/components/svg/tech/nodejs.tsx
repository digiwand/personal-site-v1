  ...
  return (
    ...
    >
      <defs>
        ...
        <linearGradient id="svg-nodejs-b" x1="-.348" x2="1.251" gradientTransform="rotate(116.114 53.1 202.97) scale(86.48)" gradientUnits="userSpaceOnUse">
          <stop offset=".3" stopColor="#3E863D" />
          <stop offset=".5" stopColor="#55934F" />
          <stop offset=".8" stopColor="#5AAD45" />
        </linearGradient>
        <clipPath id="svg-nodejs-c">
        ...
        <linearGradient id="svg-nodejs-d" x1="-.456" x2=".582" gradientTransform="rotate(-36.46 550.846 -214.337) scale(132.798)" gradientUnits="userSpaceOnUse">
          <stop offset=".57" stopColor="#3E863D" />
          <stop offset=".72" stopColor="#619857" />
          <stop offset="1" stopColor="#76AC64" />
        </linearGradient>
        <clipPath id="svg-nodejs-e">
        ...
        <linearGradient id="svg-nodejs-f" x1=".043" x2=".984" gradientTransform="translate(192.862 279.652) scale(97.417)" gradientUnits="userSpaceOnUse">
      ...
      <path
        sx={(theme) => ({ fill: `${theme.colors.svgNodeJs}` })}
        fillRule="evenodd"
      ...
      <g clipPath="url(#svg-nodejs-a)" transform="translate(-78.306 -164.016)">
        <path fill="url(#svg-nodejs-b)" d="M331.363 246.793l-118.715-58.19-60.87 124.174L270.49 370.97zm0 0" />
      </g>
      <g clipPath="url(#svg-nodejs-c)" transform="translate(-78.306 -164.016)">
        <path fill="url(#svg-nodejs-d)" d="M144.07 264.004l83.825 113.453 110.86-81.906-83.83-113.45zm0 0" />
      </g>
      <g clipPath="url(#svg-nodejs-e)" transform="translate(-78.306 -164.016)">
        <path fill="url(#svg-nodejs-f)" d="M197.02 225.934v107.43h91.683v-107.43zm0 0" />
      </g>
    </svg>
  );
}
